# Chapter 9 c PLUS PLUS team PROJECT

C++ team project that finds total scores and averages and some other stuff

## who does what?

| Function name | Arguments | Desc | Who? |
| -- | -- | -- | -- |
| double Get_Input() | none | Takes input dynamically and returns an array of pointers to test scores | GAGE WILLIAM BOYD |
| void Sort_Array() | double Array of Pointers | Sorts the array from lowest to highest. | LIAM CALVIN DOWELL |
